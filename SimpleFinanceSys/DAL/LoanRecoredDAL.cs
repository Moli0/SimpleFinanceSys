...
namespace DAL
{
    ...
    public partial class LoanRecoredDAL : BaseDal
    {
        ...
        ///添加一条数据(返)插入的数据的id）
        /// </summary>
        public int Add(Model.LoanRecoredModel model)
        {
            string sqlStr = " insert into [LoanRecored](id,create_time,create_user,last_time,last_user,state,recordType,orderId,topOrderId,title,orderObject,amount,interestRateType,interestRate,endTime,nowAmount,isFinish,remark) values(@id,@create_time,@create_user,@last_time,@last_user,@state,@recordType,@orderId,@topOrderId,@title,@orderObject,@amount,@interestRateType,@interestRate,@endTime,@nowAmount,@isFinish,@remark);select @@idmodel ";
        ...
        {
            string sqlStr = " insert into [LoanRecored](id,create_time,create_user,last_time,last_user,state,recordType,orderId,topOrderId,title,orderObject,amount,interestRateType,interestRate,endTime,nowAmount,isFinish,remark) ";
        ...
        {
            string sqlStr = " update [LoanRecored] set create_user=@create_user,last_time=@last_time,last_user=@last_user,state=@state,recordType=@recordType,orderId=@orderId,title=@title,amount=@amount,interestRateType=@interestRateType,interestRate=@interestRate,endTime=@endTime,nowAmount=@nowAmount,isFinish=@isFinish,remark=@remark where id = @id";
            using (var connection = new ConnectionCode().GetConnection())
            {
